...
public class CyberManagementPanel extends JPanel {
    ...
    private JPanel createComputerPanel(int id) {
        ...
        JLabel iconLabel = new JLabel(new ImageIcon("C:\\Users\\KENNED\\Desktop\\Segundo Parcial PPS\\Paradigm-Pioneers\\CODE\\EDICOMPUCyberManagementSystem(Maven)\\Logotipo - EDICOMPU\\Compu.png"));
