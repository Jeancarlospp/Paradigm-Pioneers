...
public class CyberManagementPanel extends JPanel {
    ...
    private JPanel createComputerPanel(int id) {
        ...
        JLabel iconLabel = new JLabel(new ImageIcon("C:\\Users\\Sjean\\Desktop\\Segundo Semestre Ing.Software\\POO\\Repositorio Proyecto POO\\Paradigm-Pioneers\\CODE\\EDICOMPUCyberManagementSystem(Maven)\\Logotipo - EDICOMPU\\Compu.png"));
